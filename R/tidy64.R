#' Helper for constructing tidy64 objects
#'
#' @description
#' `tidy64()` is the easiest way to construct new tidy64 objects from existing
#' integer, double, or logical vectors.
#'
#' `tidy64()` is meant to be a lossless converter to tidy64. Integers and
...
#'
#' [as_tidy64()] allows lossy conversion to tidy64. It will truncate doubles
#' towards `0`. It is also the way to parse character vectors as tidy64.
#'
#' @param x `[double / logical / integer]`
#'
