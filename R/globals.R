...
delayedAssign("tidy64_global_max_lossless_double_chr", "9007199254740991") # 2^53-1
delayedAssign("tidy64_global_min_lossless_double_chr", "-9007199254740991") # -2^53-1
