...
test_that("can subtract", {
  x <- tidy64(1)
  y <- tidy64(2)

  expect_identical(x - y, tidy64(-1))
  expect_identical(y - x, tidy64(1))
})
...
test_that("uses tidy recycling", {
  ...
  expect_identical(x - y, tidy64(c(0, -1)))
  expect_error(y - z, class = "vctrs_error_incompatible_size")
})
...
test_that("warns and returns NA on overflow", {
  ...
  expect_identical(expect_warning(tidy64_global_min - x), tidy64(NA))
  expect_identical(expect_warning(y - tidy64_global_max), tidy64(NA))
})
...
test_that("uses tidy recycling", {
  ...
  expect_identical(x - b, tidy64(c(0, -1)))
  expect_identical(b - x, tidy64(c(0, 1)))

  expect_identical(y - a, tidy64(c(0, 1)))
  expect_identical(a - y, tidy64(c(0, -1)))
...
test_that("can subtract", {
  ...
  expect_identical(x - y, tidy64(0))
  expect_identical(y - x, tidy64(0))
})
...
test_that("uses tidy recycling", {
  ...
  expect_identical(x - b, c(0, -1))
  expect_identical(b - x, c(0, 1))

  expect_identical(y - a, c(0, 1))
  expect_identical(a - y, c(0, -1))
...
test_that("no overflow warning since we convert to double", {
  ...
  expect_warning(tidy64_global_min - x, NA)
  expect_warning(y - tidy64_global_max, NA)
})
...
test_that("uses tidy recycling", {
  ...
  expect_identical(x * y, tidy64(c(1, 2)))
  expect_error(y * z, class = "vctrs_error_incompatible_size")
})
...
test_that("warns and returns NA on overflow", {
  ...
  expect_identical(expect_warning(tidy64_global_max * x), tidy64(NA))
  expect_identical(expect_warning(y * tidy64_global_max), tidy64(NA))
})
...
test_that("uses tidy recycling", {
  ...
  expect_identical(x * b, tidy64(c(1, 2)))
  expect_identical(b * x, tidy64(c(1, 2)))

  expect_identical(y * a, tidy64(c(1, 2)))
  expect_identical(a * y, tidy64(c(1, 2)))
...
test_that("uses tidy recycling", {
  ...
  expect_identical(x * b, tidy64(c(1, 0)))
  expect_identical(b * x, tidy64(c(1, 0)))
...
test_that("uses tidy recycling", {
  ...
  expect_identical(x * b, c(1, 2))
  expect_identical(b * x, c(1, 2))

  expect_identical(y * a, c(1, 2))
  expect_identical(a * y, c(1, 2))
...
test_that("no overflow warning since we convert to double", {
  ...
  expect_warning(tidy64_global_max * x, NA)
  expect_warning(y * tidy64_global_max, NA)
})
